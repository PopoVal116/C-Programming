...
Работа функции main
Функция main отвечает за выбор и запуск одного из шести заданий:

1. Пользователю предлагается ввести номер задания (от 1 до 6).

2. С помощью оператора switch программа вызывает соответствующую функцию (ex1–ex6) для выполнения выбранного задания.

3. Если введено некорректное значение, выводится сообщение об ошибке.

Таким образом, main реализует простой интерфейс для управления демонстрацией возможностей работы с потоками.
